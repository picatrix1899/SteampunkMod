...
public class BlockWitherFarm extends Block implements ITileEntityProvider
{
	public static final PropertyDirection FACING = BlockHorizontal.FACING;

	public BlockWitherFarm()
	{
		super(Material.IRON);
		setCreativeTab(TabList.FARMS);
		setUnlocalizedName("witherFarm");
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		// TODO Auto-generated method stub
		return new TileEntityWitherFarm();
	}
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, @Nullable ItemStack heldItem, EnumFacing side, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            {
            	playerIn.openGui(SteampunkMod.instance, 0, worldIn, pos.getX(), pos.getY(), pos.getZ());
            }
